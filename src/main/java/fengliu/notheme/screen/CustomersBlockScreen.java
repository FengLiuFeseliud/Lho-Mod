...
public class CustomersBlockScreen extends HandledScreen<CustomersBlockScreenHandler> {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        drawTextWithShadow(matrices, this.textRenderer, Text.translatable("notheme.block.customers_block.info.width", width), this.x + 89, this.y + 43, 0xffffff);
        drawTextWithShadow(matrices, this.textRenderer, Text.translatable("notheme.block.customers_block.info.height", height), this.x + 89, this.y + 51, 0xffffff);
        drawTextWithShadow(matrices, this.textRenderer, Text.translatable("notheme.block.customers_block.info.size", width, height, width * height), this.x + 89, this.y + 59, 0xffffff);
    }
