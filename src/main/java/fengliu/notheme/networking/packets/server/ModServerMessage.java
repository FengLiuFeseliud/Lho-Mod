...
public class ModServerMessage {
    ...
    public static final Identifier SYNC_VENDING_MACHINE = IdUtil.get("sync_vending_machine");
    ...
    public static void registerS2CPackets(){
        ...
        ClientPlayNetworking.registerGlobalReceiver(SYNC_VENDING_MACHINE, BlockEntitySync::syncVendingMachine);
